...
--
-- Name: shipping_costs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.shipping_costs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.shipping_costs_id_seq OWNER TO postgres;

--
-- Name: shipping_costs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.shipping_costs_id_seq OWNED BY public.shipping_costs.id;
...
CREATE TABLE public.users (
    ...
    CONSTRAINT address_has_coordinates CHECK (((address ? 'latitude'::text) AND (address ? 'longitude'::text))),
...
--
-- Name: shipping_costs id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.shipping_costs ALTER COLUMN id SET DEFAULT nextval('public.shipping_costs_id_seq'::regclass);
...
1	Electronics	{"color": ["red", "blue", "green"]}	2024-11-27 19:08:37.663183
2	Gaming	{"color": ["red", "blue", "green"]}	2024-11-27 19:08:37.663183
3	Wearables	{}	2024-11-27 19:08:37.663183
4	Home Office	{}	2024-11-27 19:08:37.663183
5	Fitness	{}	2024-11-27 19:08:37.663183
6	Fashion	{"size": ["S", "M", "L", "XL"], "color": ["black", "white", "red", "blue", "green"]}	2024-11-27 19:08:37.663183
7	Kitchenware	{"color": ["white", "black", "gray"], "material": ["plastic", "stainless steel", "ceramic"]}	2024-11-27 19:08:37.663183
8	Books	{}	2024-11-27 19:08:37.663183
9	Gadget	{"color": ["black", "white", "silver", "blue"], "storage": ["64GB", "128GB", "256GB", "512GB"]}	2024-11-27 19:08:37.663183
10	Beauty	{}	2024-11-27 19:08:37.663183
\.
...
1	1	1800.00	\N	FREE	completed	2024-11-27 19:08:37.663183
2	2	450.00	\N	FREE	pending	2024-11-27 19:08:37.663183
3	3	300.00	\N	FREE	completed	2024-11-27 19:08:37.663183
4	4	600.00	\N	FREE	canceled	2024-11-27 19:08:37.663183
5	5	1000.00	\N	FREE	completed	2024-11-27 19:08:37.663183
6	1	550.00	\N	FREE	pending	2024-11-27 19:08:37.663183
7	2	700.00	\N	FREE	completed	2024-11-27 19:08:37.663183
8	3	400.00	\N	FREE	completed	2024-11-27 19:08:37.663183
9	4	150.00	\N	FREE	completed	2024-11-27 19:08:37.663183
10	5	250.00	\N	FREE	pending	2024-11-27 19:08:37.663183
\.
...
COPY public.shipping_costs (id, name, cost) FROM stdin;
1	Standard Shipping	5.00
2	Express Shipping	15.00
3	International Shipping	30.00
4	Same Day Delivery	25.00
5	Standard Shipping	5.00
6	Express Shipping	15.00
7	International Shipping	30.00
8	Same Day Delivery	25.00
\.
...
1	John Doe	john.doe@example.com	1234567890	{"city": "New York", "street": "123 Elm St", "latitude": 40.7128, "longitude": -74.0060, "postal_code": "10001"}	password123	2024-11-27 19:08:37.663183	2024-11-27 19:08:37.663183
2	Jane Smith	jane.smith@example.com	9876543210	{"city": "Los Angeles", "street": "456 Oak Rd", "latitude": 34.0522, "longitude": -118.2437, "postal_code": "90001"}	password456	2024-11-27 19:08:37.663183	2024-11-27 19:08:37.663183
3	Alice Johnson	alice.johnson@example.com	5551234567	{"city": "Chicago", "street": "789 Pine Ave", "latitude": 41.8781, "longitude": -87.6298, "postal_code": "60601"}	password789	2024-11-27 19:08:37.663183	2024-11-27 19:08:37.663183
4	Bob Williams	bob.williams@example.com	5557654321	{"city": "San Francisco", "street": "101 Maple Dr", "latitude": 37.7749, "longitude": -122.4194, "postal_code": "94105"}	password101	2024-11-27 19:08:37.663183	2024-11-27 19:08:37.663183
5	Charlie Davis	charlie.davis@example.com	1456782345	{"city": "San Francisco", "street": "101 Maple Dr", "latitude": 37.7749, "longitude": -122.4194, "postal_code": "94105"}	password202	2024-11-27 19:08:37.663183	2024-11-27 19:08:37.663183
\.
...
--
-- Name: shipping_costs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.shipping_costs_id_seq', 8, true);
...
ALTER TABLE ONLY public.shipping_costs
    ADD CONSTRAINT shipping_costs_pkey PRIMARY KEY (id);
